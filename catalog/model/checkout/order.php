	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				$data['link'] = $order_info['store_url'] . 'index.php?routes=account/order/info&order_id=' . $order_id;
	
				if ($download_status) {
					$data['download'] = $order_info['store_url'] . 'index.php?routes=account/download';
				} else {
					$data['download'] = '';
				}
				...
				if ($order_info['customer_id']) {
					...
					$text .= $order_info['store_url'] . 'index.php?routes=account/order/info&order_id=' . $order_id . "\n\n";
				}
	
				if ($download_status) {
					$text .= $language->get('text_new_download') . "\n";
					$text .= $order_info['store_url'] . 'index.php?routes=account/download' . "\n\n";
				}
			...
			if ($order_info['order_status_id'] && $order_status_id && $notify) {
				...
				if ($order_info['customer_id']) {
					...
					$message .= $order_info['store_url'] . 'index.php?routes=account/order/info&order_id=' . $order_id . "\n\n";
				}
