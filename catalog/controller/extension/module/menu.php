...
class ControllerExtensionModuleMenu extends Controller {
	...
	public function index($setting) {
		...
		if($results){
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'extension/module/menu')) {

				return $this->load->view($this->config->get('config_template') . 'extension/module/menu', $data);
