...
$(document).ready(function() {
    $.ajax({
        url: 'index.php?routes=checkout/login',
        dataType: 'html',
...
$(document).ready(function() {
    $.ajax({
        url: 'index.php?routes=checkout/payment_address',
        dataType: 'html',
        success: function(html) {
...
$(document).delegate('#button-account', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/' + $('input[name=\'account\']:checked').val(),
        dataType: 'html',
        beforeSend: function() {
...
$(document).delegate('#button-login', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/login/save',
        type: 'post',
...
$(document).delegate('#button-register', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/register/save',
        type: 'post',
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (shipping_address) {
                    $.ajax({
                        url: 'index.php?routes=checkout/shipping_method',
                        dataType: 'html',
                        success: function(html) {
							// Add the shipping address
                            $.ajax({
                                url: 'index.php?routes=checkout/shipping_address',
                                dataType: 'html',
                                success: function(html) {
                ...
                <?php } else { ?>
                $.ajax({
                    url: 'index.php?routes=checkout/payment_method',
                    dataType: 'html',
                    success: function(html) {
...
$(document).delegate('#button-payment-address', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/payment_address/save',
        type: 'post',
...
$(document).delegate('#button-shipping-address', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/shipping_address/save',
        type: 'post',
...
$(document).delegate('#button-guest', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/guest/save',
        type: 'post',
                ...
                if (shipping_address) {
                    $.ajax({
                        ...
                        success: function(html) {
							// Add the shipping address
                            $.ajax({
                                url: 'index.php?routes=checkout/guest_shipping',
                                dataType: 'html',
                                success: function(html) {
                                    $('#collapse-shipping-address .panel-body').html(html);
...
$(document).delegate('#button-guest-shipping', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/guest_shipping/save',
        type: 'post',
        data: $('#collapse-shipping-address input[type=\'text\'], #collapse-shipping-address input[type=\'date\'], #collapse-shipping-address input[type=\'datetime-local\'], #collapse-shipping-address input[type=\'time\'], #collapse-shipping-address input[type=\'password\'], #collapse-shipping-address input[type=\'checkbox\']:checked, #collapse-shipping-address input[type=\'radio\']:checked, #collapse-shipping-address textarea, #collapse-shipping-address select'),
        dataType: 'json',
        beforeSend: function() {
...
$(document).delegate('#button-shipping-method', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/shipping_method/save',
        type: 'post',
...
$(document).delegate('#button-payment-method', 'click', function() {
    $.ajax({
        url: 'index.php?routes=checkout/payment_method/save',
        type: 'post',
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    url: 'index.php?routes=checkout/confirm',
                    dataType: 'html',
                    complete: function() {
                        $('#button-payment-method').button('reset');
                    },
