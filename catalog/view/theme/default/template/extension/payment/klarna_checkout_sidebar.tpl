    ...
    $.ajax({
        ...
        success: function(json) {
            if (json['redirect']) {
				...
				$.post('index.php?routes=extension/payment/klarna_checkout/main', {response: 'json'}, function() {
...
var kc = {
	'cartRemove': function(key) {
		...
		$.ajax({
			...
			success: function(json) {
				$.post('index.php?routes=extension/payment/klarna_checkout/main', {response: 'json'}, function(data) {
					if (data['redirect']) {
