...
((__t = ( Formbuilder.options.mappings.HIDDEN )) == null ? '' : __t) +
'\'\n  placeholder=\'Enter Value\' /><br />Any value. You can also integrate customer data. Available customer data are: {firstName}, {lastName}, {name}, {address}, {email}, {city}, {state}, {zip}, {company} ';
