  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://www.hitechfocus.com" target="_blank"><?php echo $text_homepage; ?></a></li>
        <li><a href="http://docs.hitechfocus.com" target="_blank"><?php echo $text_documentation; ?></a></li>
        <li><a href="http://forum.hitechfocus.com" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
