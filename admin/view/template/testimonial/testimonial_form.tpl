...
<div id="content" class="simple">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-testimonial"  title="<?php echo $button_save; ?>" class="btn btn-primary"><?php echo $button_save; ?></button>           
    ...
    <div class="container-fluid">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-testimonial" class="form-horizontal">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-12">
                                     <?php if(isset($action_add)) { ?>
                                        <input type="text" name="testimonial_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($testimonial_description[$language['language_id']]) ? $testimonial_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" onkeyup="ChangeToSlug();" id="input-name<?php echo $language['code']; ?>" class="form-control"/>
                                      <?php } else { ?>
                                        <input type="text" name="testimonial_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($testimonial_description[$language['language_id']]) ? $testimonial_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['code']; ?>" class="form-control"/>
                                      <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea data-toggle="summernote" data-lang="<?php echo $language['code']; ?>" name="testimonial_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="editor_chili"><?php echo isset($testimonial_description[$language['language_id']]) ? $testimonial_description[$language['language_id']]['description'] : ''; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group required">
                ...
                <div class="right-col col-lg-4">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <div class="form-group">
                              <label class="col-sm-12" for="input-testimonial_category"><span data-toggle="tooltip" title="<?php echo $help_category; ?>"><?php echo $entry_category; ?></span></label>
                              <div class="col-sm-12">
                                  <input type="text" name="testimonial_category" value="" placeholder="<?php echo $entry_category; ?>" id="input-testimonial_category" class="form-control input-full-width" style="margin-bottom: 5px !important;"/>
                                  <?php if (!empty($testimonial_categories)) { ?>
                                  <div id="testimonial_category" class="well well-sm" style="overflow: auto;">
                                      <?php foreach ($testimonial_categories as $testimonial_category) { ?>
                                      <div id="testimonial_category<?php echo $testimonial_category['testimonial_category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $testimonial_category['name']; ?>
                                          <input type="hidden" name="testimonial_category[]" value="<?php echo $testimonial_category['testimonial_category_id']; ?>" />
                                      </div>
                                      <?php } ?>
                                  </div>
                                  <?php } ?>
                          ...
                          <div class="form-group">
                              <label class="col-sm-12" for="input-testimonial_related"><span data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php echo $entry_related; ?></span></label>
                              <div class="col-sm-12">
                                  <input type="text" name="testimonial_related" value="" placeholder="<?php echo $entry_related; ?>" id="input-testimonial_related" class="form-control input-full-width" style="margin-bottom: 5px !important;"/>
                                  <?php if (!empty($testimonial_relateds)) { ?>
                                  <div id="testimonial_related" class="well well-sm" style="overflow: auto;">
                                      <?php foreach ($testimonial_relateds as $testimonial_related) { ?>
                                      <div id="testimonial_related<?php echo $testimonial_related['testimonial_category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $testimonial_related['name']; ?>
                                          <input type="hidden" name="testimonial_related[]" value="<?php echo $testimonial_related['testimonial_category_id']; ?>" />
                                      </div>
                                      <?php } ?>
                                  </div>
                                  <?php } ?>
            ...
            <input type="hidden" name="testimonial_store[]" value="0" checked="checked" />
            <?php } else { ?>
            <input type="hidden" name="testimonial_store[]" value="0" />
            <?php } ?>
            <?php foreach ($stores as $store) { ?>
            <?php if (in_array($store['store_id'], $testimonial_store)) { ?>
            <input type="hidden" name="testimonial_store[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
            <?php } else { ?>
            <input type="hidden" name="testimonial_store[]" value="<?php echo $store['store_id']; ?>" />
            <?php } ?>
            <?php } ?>
           
            <?php foreach ($stores as $store) { ?>
            <select name="testimonial_layout[<?php echo $store['store_id']; ?>]" class="hidden">
                <option value=""></option>
    ...
    $('.tag-select').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'testimonial/testimonial/autocomplete?token=<?php echo $token; ?>&tag_name=' +  encodeURIComponent(request),
                type: 'post',
    ...
    // Portfolio related
    $('input[name=\'testimonial_related\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?routes=testimonial/testimonial/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
                dataType: 'json',
                success: function(json) {
        ...
        'select': function(item) {
            $('input[name=\'testimonial_related\']').val('');
            if (!$('#testimonial_related').length) {
                $('input[name=\'testimonial_related\']').after('<div id="testimonial_related" class="well well-sm" style="overflow: auto;"></div>');
            }
            $('#testimonial_related' + item['value']).remove();
            $('#testimonial_related').append('<div style="width:100%" id="testimonial_related' + item['value'] + '"><i style="color: #f41f1f;" class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="testimonial_related[]" value="' + item['value'] + '" /></div>');
        }
    });
    $(document).on('click', '#testimonial_related .fa-minus-circle', function() {
        $(this).parent().remove();
        if (!$("div[id^='testimonial_related'] i").hasClass('fa-minus-circle')) {
            $('#testimonial_related').remove();
        }
    });
    // Category
    $('input[name=\'testimonial_category\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?routes=testimonial/testimonial_category/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
                dataType: 'json',
                success: function(json) {
                    if ((typeof(json) != 'undefined' || typeof(json) != 'object') && (json == null || json == '')) {
                        $('.btn-category-add').remove();
                    ...
                    response($.map(json, function(item) {
                        return {
                            label: item['name'],
                            value: item['testimonial_category_id']
                        }
                    }));
                }
            });
        ...
        'select': function(item) {
            $('input[name=\'testimonial_category\']').val('');
            if (!$('#testimonial_category').length) {
                $('input[name=\'testimonial_category\']').after('<div id="testimonial_category" class="well well-sm" style="overflow: auto;"></div>');
            }
            $('#testimonial_category' + item['value']).remove();
            $('#testimonial_category').append('<div id="testimonial_category' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="testimonial_category[]" value="' + item['value'] + '" /></div>');
        }
    });
    $(document).on('click', '#testimonial_category .fa-minus-circle', function() {
        $(this).parent().remove();
        if (!$("div[id^='testimonial_category'] i").hasClass('fa-minus-circle')) {
            $('#testimonial_category').remove();
        }
    });
    $(document).on('click', '.btn-category-add', function() {
        $.ajax({
            url: 'index.php?routes=testimonial/testimonial/quick&token=<?php echo $token; ?>',
            type: 'post',
            data: {name: $('#input-testimonial_category').val(), sort_order: '0', status: '1', column: '1', parent_id: '0'},
            dataType: 'json',
            success: function(json) {
                if (json['success']) {
                    $('.btn-category-add').remove();
                    ...
                    html  = '<div id="testimonial_category' + json['testimonial_category_id'] + '">';
                    html += '    <i class="fa fa-minus-circle"></i> ' + $('#input-testimonial_category').val();
                    html += '    <input type="hidden" name="testimonial_category[]" value="' + json['testimonial_category_id'] + '">';
                    html += '</div>';
                    $('#input-testimonial_category').val('');
                    $('#testimonial_category').append(html);
                    $('#input-testimonial_category').after('<p id="quick-category-success" class="text-success">' + json['success'] + '</p>').fadeIn(3000);
                }
            }
        }).done(function() {
            setTimeout(function(){
...
<?php if($image_manager_status==1){?>
  function insertImage(fileName) {  
      if ($.rcookie('testimonial<?php echo $testimonial_id; ?>_image_row')==null||$.rcookie('testimonial<?php echo $testimonial_id; ?>_image_row')=='') {
        var cookie_add_row = <?php echo $image_row; ?>; 
      }else{  
        var cookie_add_row = $.rcookie('testimonial<?php echo $testimonial_id; ?>_image_row');
      }         
      var add_row = cookie_add_row;
      $.rcookie('testimonial<?php echo $testimonial_id; ?>_image_row',null);
      html  = '<tr class="image-row" id="image-row' + add_row + '">';
      html += '  <td class="text-left"><a href="" id="thumb-image' + add_row + '"data-toggle="image" class="img-thumbnail"><img style="width:50px;" src="../image/' + fileName + '" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="testimonial_image[' + add_row + '][image]" value="' + fileName + '" id="input-image' + add_row + '" /></td>';
      html += '<td class="text-center"><input type="radio" name="primary_image" onclick="changePrimaryImage(' + add_row + ')"/></td>';
      html += '<td class="text-right" hidden><input type="text" name="testimonial_image[' + add_row + '][sort_order]" value="' + add_row + '" placeholder="<?php echo $entry_sort_order; ?>" class="form-control sort_order" /></td>';
      ...
      $.rcookie('testimonial<?php echo $testimonial_id; ?>_image_row',numrow);  
      add_row++;    
  };
<?php } ?>
