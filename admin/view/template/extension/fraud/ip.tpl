...
$('#ip').load('index.php?routes=extension/fraud/ip/ip&token=<?php echo $token; ?>');

$('#button-ip-add').on('click', function() {
	$.ajax({
		url: 'index.php?routes=extension/fraud/ip/addip&token=<?php echo $token; ?>',
		type: 'post',
		dataType: 'json',
...
$('#ip').delegate('button', 'click', function() {
	...
	$.ajax({
		url: 'index.php?routes=extension/fraud/ip/removeip&token=<?php echo $token; ?>',
		type: 'post',
		dataType: 'json',
