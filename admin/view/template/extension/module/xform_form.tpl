                           ...
                           <div class="tab-pane<?php if(!$active_class) echo ' active'; $active_class='1'; ?>" id="language<?php echo $language['language_id']; ?>core">                                   
                             ...
                             <div class="form-group">
                                <label class="col-sm-2 control-label" for="formDescription<?php echo $language['language_id']; ?>"><?php echo $text_form_desc;?></label>
                                  <div class="col-sm-10">
                                   <textarea data-toggle="summernote" data-lang="<?php echo $language_code; ?>" class="form-control" style="height:100px;" name="formDesc[<?php echo $language['language_id']; ?>][formDescription]" id="formDescription<?php echo $language['language_id']; ?>"><?php echo isset($formDesc[$language['language_id']]['formDescription']) ? $formDesc[$language['language_id']]['formDescription'] : ''; ?></textarea>
                                  </div>
                                </div>
                             </div> 
                           <?php } ?>
                        ...
                        <div class="tab-content lang-tab">
                            ...
                            <div class="tab-pane<?php if(!$active_class) echo ' active'; $active_class='1'; ?>" id="language<?php echo $language['language_id']; ?>other">  
                               ...
                               <div class="form-group success-message" <?php if($formdata['successType']!='self') echo 'style="display:none;"';?>>
                                 ...
                                 <div class="col-sm-10">
                                   <textarea data-toggle="summernote" data-lang="<?php echo $language_code; ?>" class="form-control editor" style="height:100px;"  name="formDesc[<?php echo $language['language_id']; ?>][successMsg]" id="successMsg<?php echo $language['language_id']; ?>"><?php echo isset($formDesc[$language['language_id']]['successMsg']) ? $formDesc[$language['language_id']]['successMsg'] : ''; ?></textarea>
                                 </div>
                              </div>
                             <div class="form-group admin-email" <?php if($formdata['sendAdminEmail']!=1) echo 'style="display:none;"';?> >
                            ...
                            <div class="form-group admin-email" <?php if($formdata['sendAdminEmail']!=1) echo 'style="display:none;"';?> >
                               ...
                               <div class="col-sm-10">
                                 <textarea data-toggle="summernote" data-lang="<?php echo $language_code; ?>" class="form-control editor" name="formDesc[<?php echo $language['language_id']; ?>][adminEmailContent]" id="adminEmailContent<?php echo $language['language_id']; ?>"><?php echo isset($formDesc[$language['language_id']]['adminEmailContent']) ? $formDesc[$language['language_id']]['adminEmailContent'] : ''; ?></textarea>
                               </div>
                            </div> 
                             <div class="form-group user-email" <?php if($formdata['sendUserEmail']!=1) echo 'style="display:none;"';?> >
                            ...
                            <div class="form-group user-email" <?php if($formdata['sendUserEmail']!=1) echo 'style="display:none;"';?> >
                               ...
                               <div class="col-sm-10">
                                 <textarea data-toggle="summernote" data-lang="<?php echo $language_code; ?>" class="form-control editor" name="formDesc[<?php echo $language['language_id']; ?>][userEmailContent]" id="userEmailContent<?php echo $language['language_id']; ?>"><?php echo isset($formDesc[$language['language_id']]['userEmailContent']) ? $formDesc[$language['language_id']]['userEmailContent'] : ''; ?></textarea>
                               </div>
                            </div> 
                          </div>
                           <?php }?>
...
<script src="view/javascript/xform/fb_<?php echo $language_code; ?>.js"></script> 
