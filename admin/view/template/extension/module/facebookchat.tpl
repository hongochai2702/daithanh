...
<div id="content">
 <div class="page-header">
    <div class="container-fluid">
      <h1><i class="fa fa-phone-square"></i>&nbsp;<?php echo $heading_title; ?></h1>
      <ul class="breadcrumb">
      ...
      <?php if ($error_warning) { ?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i>&nbsp;<span style="vertical-align:middle;font-weight:bold;"><?php echo $text_setting; ?></span></h3>
                    ...
                    <div class="form-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php foreach ($stores  as $st) { ?>
                                <li><a href="index.php?routes=extension/module/facebookchat&store_id=<?php echo $st['store_id'];?>&token=<?php echo $token; ?>"><?php echo $st['name']; ?></a></li>
                            <?php } ?> 
                        </ul>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"> 
                    ...
                    <input type="hidden" name="facebookchat_status" value="1" />
                    <div class="tabbable">
                        <div class="tab-navigation form-inline">
                            <ul class="nav nav-tabs mainMenuTabs" id="mainTabs">
                                <li><a href="#control_panel" data-toggle="tab"><i class="fa fa-power-off"></i>&nbsp;Hiển thị</a></li>
                                <li id="mainSettingsTab"><a href="#main_settings" data-toggle="tab"><i class="fa fa-cogs"></i>&nbsp; Cấu hình</a></li>
						...
						?>
                            <div id="main_settings" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/extension/module/facebookchat/tab_settings.php'); ?></div>
                            <div id="control_panel" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/extension/module/facebookchat/tab_controlpanel.php'); ?></div>
                        </div> <!-- /.tab-content --> 
                    </div><!-- /.tabbable -->
                </form>
            </div> 
