...
<script type="text/javascript"><!--
	...
	$('#button-capture').click(function() {
		if (confirm('<?php echo $text_confirm_capture; ?>')) {
			$.ajax({
				...
				url: 'index.php?routes=extension/payment/cardconnect/capture&token=<?php echo $token; ?>',
				beforeSend: function() {
	...
	$('#button-refund').click(function() {
		if (confirm('<?php echo $text_confirm_refund; ?>')) {
			$.ajax({
				...
				url: 'index.php?routes=extension/payment/cardconnect/refund&token=<?php echo $token; ?>',
				beforeSend: function() {
	...
	$(document).on('click', '.button-inquire', function(e) {
		...
		$.ajax({
			...
			url: 'index.php?routes=extension/payment/cardconnect/inquire&token=<?php echo $token; ?>',
			beforeSend: function() {
				button.hide();
				button.next().show();
				$('.cardconnect_message').remove();
	...
	$(document).on('click', '.button-void', function(e) {
		...
		$.ajax({
			...
			url: 'index.php?routes=extension/payment/cardconnect/void&token=<?php echo $token; ?>',
			beforeSend: function() {
				button.hide();
				button.next().show();
				$('.cardconnect_message').remove();
