  ...
  $("#button-cancel").click(function () {
      if (confirm('<?php echo $text_confirm_cancel; ?>')) {
        $.ajax({
          ...
          url: 'index.php?routes=extension/payment/amazon_login_pay/cancel&token=<?php echo $token; ?>',
          beforeSend: function () {
            $('#button-cancel').hide();
            $('#loading-cancel').show();
    ...
    $("#button-capture").click(function () {
      if (confirm('<?php echo $text_confirm_capture; ?>')) {
        $.ajax({
          ...
          url: 'index.php?routes=extension/payment/amazon_login_pay/capture&token=<?php echo $token; ?>',
          beforeSend: function () {
            $('#button-capture').hide();
            $('#capture-amount').hide();
    ...
    $("#button-refund").click(function () {
      if (confirm('<?php echo $text_confirm_refund; ?>')) {
        $.ajax({
          ...
          url: 'index.php?routes=extension/payment/amazon_login_pay/refund&token=<?php echo $token; ?>',
          beforeSend: function () {
            $('#button-refund').hide();
            $('#refund-amount').hide();
            $('#loading-refund').show();
