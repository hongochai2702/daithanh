  ...
  $(document).on('click', '#button-void', function(){
		if (confirm('<?php echo $text_confirm_void; ?>')) {
			$.ajax({
				...
				url: 'index.php?routes=extension/payment/bluepay_hosted/void&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-void').hide();
	...
	$(document).on('click', '#button-release', function(){
		if (confirm('<?php echo $text_confirm_release; ?>')) {
			$.ajax({
				...
				url: 'index.php?routes=extension/payment/bluepay_hosted/release&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-release').hide();
					$('#release_amount').hide();
	...
	$(document).on('click', '#button-rebate', function(){
		if (confirm('<?php echo $text_confirm_rebate; ?>')) {
			$.ajax({
				...
				url: 'index.php?routes=extension/payment/bluepay_hosted/rebate&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-rebate').hide();
					$('#rebate_amount').hide();
