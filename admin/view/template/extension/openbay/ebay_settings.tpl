...
<script type="text/javascript"><!--
    $('#button-clear-locks').bind('click', function() {
      $.ajax({
        url: 'index.php?routes=extension/openbay/ebay/deleteAllLocks&token=<?php echo $token; ?>',
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    $('#button-repair-links').bind('click', function() {
      $.ajax({
        url: 'index.php?routes=extension/openbay/ebay/repairLinks&token=<?php echo $token; ?>',
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    function checkCredentials() {
        $.ajax({
            url: 'index.php?routes=extension/openbay/ebay/verifycredentials&token=<?php echo $token; ?>',
            type: 'POST',
            dataType: 'json',
