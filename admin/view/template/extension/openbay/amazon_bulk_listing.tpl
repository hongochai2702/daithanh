...
<div id="content">
  ...
  $('#button-filter').bind('click', function() {
    url = 'index.php?routes=extension/openbay/amazon/bulkListProducts&token=<?php echo $token ?>';
  ...
  $('#button-list').bind('click', function(e) {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/amazon/doBulkList&token=<?php echo $token ?>',
      data: request_data,
      dataType: 'json',
      type: 'POST',
  ...
  $('#button-search').bind('click', function(e) {
    ...
    if (request_data != '') {
      ...
      $.ajax({
        url: 'index.php?routes=extension/openbay/amazon/doBulkSearch&token=<?php echo $token ?>',
        data: request_data,
        dataType: 'json',
        type: 'POST',
        beforeSend: function() {
