...
<script type="text/javascript"><!--
  $('#update-categories').bind('click', function() {
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/updatecategories&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  $('#update-settings').bind('click', function() {
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/updatesettings&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  $('#update-store').bind('click', function() {
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/updatestore&token=<?php echo $token; ?>',
      beforeSend: function(){
