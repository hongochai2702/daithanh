...
<script type="text/javascript"><!--
  ...
  function getSuggestedCategories() {
        var qry = $('#name').val();
        $.ajax({
            url: 'index.php?routes=extension/openbay/ebay/getSuggestedCategories&token=<?php echo $token; ?>&qry='+qry,
            type: 'GET',
            dataType: 'json',
  ...
  function loadCategories(level, skip) {
        ...
        $.ajax({
            url: 'index.php?routes=extension/openbay/ebay/getCategories&token=<?php echo $token; ?>&parent='+parent,
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.items != null) {
  ...
  function getCategoryFeatures(cat) {
        ...
        $.ajax({
            url: 'index.php?routes=extension/openbay/ebay/getCategoryFeatures&token=<?php echo $token; ?>&category='+cat,
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                if (data.error == false) {
  ...
  function getCompatibilityNames(category_id) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/getPartsCompatibilityOptions&token=<?php echo $token; ?>&category_id='+category_id,
      type: 'GET',
      dataType: 'json',
      success: function(data) {
  ...
  function getCompatibilityValues(category_id, option_name, sequence_id) {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/getPartsCompatibilityValues&token=<?php echo $token; ?>&category_id='+category_id+'&option_name='+option_name,
      type: 'POST',
  ...
  $('#button-catalog-search').bind('click', function() {
        ...
        $.ajax({
            url: 'index.php?routes=extension/openbay/ebay/searchEbayCatalog&token=<?php echo $token; ?>',
            type: 'POST',
            dataType: 'json',
  ...
  function itemFeatures(category_id) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/getEbayCategorySpecifics&token=<?php echo $token; ?>&category_id=' + category_id + '&product_id=<?php echo $product["product_id"]; ?>',
      type: 'GET',
      dataType: 'json',
      beforeSend: function() {
  ...
  function profileShippingUpdate() {
    if ($('#profile-shipping-input').val() != 'def') {
      ...
      $.ajax({
        type:'GET',
        dataType: 'json',
        url: 'index.php?routes=extension/openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#profile-shipping-input').val(),
        success: function(data) {
          setTimeout(function() {
  ...
  function addShipping(id, type) {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/getShippingService&token=<?php echo $token; ?>&loc=' + loc + '&type=' + type,
      beforeSend: function(){
  ...
  $('#button-verify').bind('click', function() {
    ...
    if (err == 0) {
        $.ajax({
            type:'POST',
            dataType: 'json',
            url: 'index.php?routes=extension/openbay/ebay/verify&token=<?php echo $token; ?>&options='+hasOptions,
            data: $("#form").serialize(),
            beforeSend: function() {
              $('#button-save').hide();
              $('#button-preview').hide();
  ...
  $('#button-save').bind('click', function() {
      ...
      $.ajax({
        type:'POST',
        dataType: 'json',
        url: 'index.php?routes=extension/openbay/ebay/listItem&token=<?php echo $token; ?>&options='+hasOptions,
        data: $("#form").serialize(),
        beforeSend: function() {
      ...
      if ($('#profile-return-input').val() != 'def') {
        ...
        $('#profile-return-input').attr('disabled', 'disabled');
          ...
          $.ajax({
              type:'GET',
              dataType: 'json',
              url: 'index.php?routes=extension/openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#profile-return-input').val(),
              success: function(data) {
                  setTimeout(function() {
  ...
  if ($('#profile-theme-input').val() != 'def') {
      ...
      $.ajax({
          type:'GET',
          dataType: 'json',
          url: 'index.php?routes=extension/openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#profile-theme-input').val(),
          success: function(data) {
              setTimeout(function() {
  ...
  function profileGenericUpdate() {
      if ($('#profile-generic-input').val() != 'def') {
          ...
          $.ajax({
              type:'GET',
              dataType: 'json',
              url: 'index.php?routes=extension/openbay/ebay_profile/profileGet&token=<?php echo $token; ?>&ebay_profile_id='+$('#profile-generic-input').val(),
              success: function(data) {
                  setTimeout(function() {
