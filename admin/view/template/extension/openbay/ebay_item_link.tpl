...
<script type="text/javascript"><!--
  function checkLinkedItems() {
      $.ajax({
          url: 'index.php?routes=extension/openbay/ebay/loadLinkedStatus&token=<?php echo $token; ?>',
  ...
  function removeLink(product_id, id) {
      $.ajax({
          type: 'GET',
          url: 'index.php?routes=extension/openbay/ebay/removeItemLink&token=<?php echo $token; ?>&product_id=' + product_id,
          dataType: 'json',
          success: function(json) {
              $('#row-' + id).fadeOut('slow');
          },
  ...
  function updateLink(item_id, qty, product_id, store_qty, reserve_qty) {
      ...
      if (r == true) {
          $.ajax({
              type: 'GET',
              url: 'index.php?routes=extension/openbay/ebay/setProductStock&token=<?php echo $token; ?>&product_id=' + product_id,
              dataType: 'json',
              success: function(json) {
                  if (json.error == false) {
  ...
  function saveListingLink(id) {
      ...
      $.ajax({
          url: 'index.php?routes=extension/openbay/ebay/saveItemLink&token=<?php echo $token; ?>&pid=' + product_id + '&itemId=' + id + '&qty=' + qty + '&ebayqty=' + ebayqty + '&variants=' + variants,
          type: 'post',
          dataType: 'json',
          beforeSend: function() {
  ...
  function getProductStock(id, element_id) {
      $.ajax({
          type:'GET',
          dataType: 'json',
          url: 'index.php?routes=extension/openbay/ebay/getProductStock&token=<?php echo $token; ?>&pid=' + id,
  ...
  $('#check-unlinked-items').bind('click', function() {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/loadUnlinked&token=<?php echo $token; ?>&page=' + unlinked_page,
      type: 'POST',
