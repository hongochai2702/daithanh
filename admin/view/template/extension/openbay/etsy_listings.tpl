...
var url = 'index.php?routes=extension/openbay/etsy_product/listings&token=<?php echo $token; ?>&page=<?php echo $filter["page"]; ?>';
...
$('#button-filter').on('click', function() {
  var url = 'index.php?routes=extension/openbay/etsy_product/listings&token=<?php echo $token; ?>';
...
function addLink() {
  ...
  $.ajax({
    url: 'index.php?routes=extension/openbay/etsy_product/addLink&token=<?php echo $token; ?>',
    dataType: 'json',
    method: 'POST',
...
function deleteLink(etsy_link_id) {
  $.ajax({
    url: 'index.php?routes=extension/openbay/etsy_product/deleteLink&token=<?php echo $token; ?>',
    dataType: 'json',
    method: 'POST',
...
function endListing(etsy_item_id) {
  ...
  if (pass == true) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy_product/endlisting&token=<?php echo $token; ?>',
      dataType: 'json',
      method: 'POST',
...
function deactivateListing(etsy_item_id) {
  ...
  if (pass == true) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy_product/deactivatelisting&token=<?php echo $token; ?>',
      dataType: 'json',
      method: 'POST',
      data: { 'etsy_item_id' : etsy_item_id },
      beforeSend: function() {
...
function activateListing(etsy_item_id) {
  ...
  if (pass == true) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy_product/activatelisting&token=<?php echo $token; ?>',
      dataType: 'json',
      method: 'POST',
      data: { 'etsy_item_id' : etsy_item_id },
      beforeSend: function() {
