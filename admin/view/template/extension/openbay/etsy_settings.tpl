...
<script type="text/javascript"><!--
  ...
  $('#button-import').bind('click', function() {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy/getorders&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  $('#button-settings').bind('click', function() {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy/settingsupdate&token=<?php echo $token; ?>',
      beforeSend: function(){
