...
<script type="text/javascript"><!--
  function filter() {
      url = 'index.php?routes=extension/openbay/items&token=<?php echo $token; ?>';
  ...
  $('#button-ebay-bulk').bind('click', function() {
    ...
    if (request_data != '') {
      $('#form').attr('action', 'index.php?routes=extension/openbay/ebay/createBulk&token=<?php echo $token; ?>').submit();
    } else {
