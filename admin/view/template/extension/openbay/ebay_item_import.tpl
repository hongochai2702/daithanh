...
<script type="text/javascript"><!--
  $('#button-import').bind('click', function() {
    ...
    if (answer) {
      ...
      $.ajax({
        url: 'index.php?routes=extension/openbay/ebay/importItems&token=<?php echo $token; ?>&desc='+import_description+'&note='+note_import+'&advanced='+import_advanced+'&categories='+import_categories,
        beforeSend: function(){
