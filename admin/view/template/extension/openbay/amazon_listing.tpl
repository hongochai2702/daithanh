...
<script type="text/javascript">
  $('#search-submit').bind('click', function(e) {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/amazon_listing/search&token=<?php echo $token; ?>',
      type: 'POST',
      dataType: 'json',
  ...
  $('#button-amazon-price').bind('click', function(e) {
    ...
    $.ajax({
        url: 'index.php?routes=extension/openbay/amazon_listing/bestPrice&token=<?php echo $token; ?>',
        type: 'POST',
        dataType: 'json',
  ...
  function getProduct(asin){
    $.ajax({
      url: 'index.php?routes=extension/openbay/amazon_listing/getProductByAsin&token=<?php echo $token; ?>',
      type: 'POST',
      dataType: 'json',
