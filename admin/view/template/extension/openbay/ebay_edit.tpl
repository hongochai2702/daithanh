...
<script type="text/javascript"><!--
  ...
  function load(){
        $.ajax({
            url: 'index.php?routes=extension/openbay/ebay/editLoad&token=<?php echo $token; ?>&product_id=<?php echo $product_id; ?>',
            type: 'GET',
            dataType: 'json',
            beforeSend: function(){
  ...
  function loadRecommendations() {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/ebay/getItemRecommendations&token=<?php echo $token; ?>&item_id=' + item_id,
      type: 'GET',
      dataType: 'json',
      success: function(data) {
        if (data.error == false) {
  ...
  $('#button-save').bind('click', function() {
    $.ajax({
      type: 'POST',
      url: 'index.php?routes=extension/openbay/ebay/editSave&token=<?php echo $token; ?>',
      dataType: 'json',
      data: $("#form").serialize(),
      beforeSend: function(){
  ...
  $('#button-remove-link').on('click', function () {
    ...
    if (pass == true) {
      $.ajax({
        type: 'GET',
        url: 'index.php?routes=extension/openbay/ebay/removeItemLink&token=<?php echo $token; ?>&product_id=<?php echo $product_id; ?>',
        dataType: 'json',
        beforeSend: function(){
  ...
  $('#button-end-item').on('click', function () {
    ...
    if (pass == true) {
      ...
      if (item_id !== '') {
        $.ajax({
          type: 'GET',
          url: 'index.php?routes=extension/openbay/ebay/endItem&token=<?php echo $token; ?>&item_id=' + item_id,
          dataType: 'json',
          beforeSend: function(){
