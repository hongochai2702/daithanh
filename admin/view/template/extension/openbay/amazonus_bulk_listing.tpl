...
$('#button-list').bind('click', function(e) {
  ...
  $.ajax({
    url: 'index.php?routes=extension/openbay/amazonus/doBulkList&token=<?php echo $token ?>',
    data: request_data,
    dataType: 'json',
    type: 'POST',
...
$('#button-search').bind('click', function(e) {
  ...
  if (request_data != '') {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/amazonus/dobulksearch&token=<?php echo $token ?>',
      data: request_data,
      dataType: 'json',
      type: 'POST',
      beforeSend: function() {
