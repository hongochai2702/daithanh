...
<script type="text/javascript"><!--
  $('#button-patch').bind('click', function(e) {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/patch&token=<?php echo $token; ?>',
      type: 'post',
      dataType: 'json',
      beforeSend: function() {
  ...
  $('#button-clear-faq').bind('click', function(e) {
    ...
    $.ajax({
      url: 'index.php?routes=extension/openbay/faqclear&token=<?php echo $token; ?>',
      beforeSend: function() {
  ...
  $('#button-clear-data').bind('click', function(e) {
    ...
    if (pass != '') {
      $.ajax({
        url: 'index.php?routes=extension/openbay/purge&token=<?php echo $token; ?>',
        type: 'post',
        dataType: 'json',
        data: 'pass=' + pass,
        beforeSend: function() {
  ...
  function updateCheckServer(beta) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/updatev2&stage=check_server&token=<?php echo $token; ?>&beta=' + beta,
      type: 'post',
      dataType: 'json',
      beforeSend: function() { },
      success: function(json) {
  ...
  function updateCheckVersion(beta) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/updatev2&stage=check_version&token=<?php echo $token; ?>&beta=' + beta,
      type: 'post',
      dataType: 'json',
      beforeSend: function() { },
      success: function(json) {
  ...
  function updateDownload(beta) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/updatev2&stage=download&token=<?php echo $token; ?>&beta=' + beta,
      type: 'post',
      dataType: 'json',
      beforeSend: function() { },
      success: function(json) {
  ...
  function updateExtract(beta) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/updatev2&stage=extract&token=<?php echo $token; ?>&beta=' + beta,
      type: 'post',
      dataType: 'json',
      beforeSend: function() { },
      success: function(json) {
  ...
  function updateRemove(beta) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/updatev2&stage=remove&token=<?php echo $token; ?>&beta=' + beta,
      type: 'post',
      dataType: 'json',
      beforeSend: function() { },
      success: function(json) {
  ...
  function updatePatch(beta) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/updatev2&stage=run_patch&token=<?php echo $token; ?>&beta=' + beta,
      type: 'post',
      dataType: 'json',
      beforeSend: function() { },
      success: function(json) {
  ...
  function updateVersion(beta) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/updatev2&stage=update_version&token=<?php echo $token; ?>&beta=' + beta,
      type: 'post',
      dataType: 'json',
      beforeSend: function() { },
      success: function(json) {
