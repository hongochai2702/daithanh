...
<script type="text/javascript"><!--
  ...
  function submitForm() {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy_product/createsubmit&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  function uploadImage(listing_id, url, id) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy_product/addimage&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  function getCategories(id_path) {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy_product/getCategories&token=<?php echo $token; ?>&id_path=' + id_path,
      beforeSend: function(){
  ...
  function getShippingProfiles() {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy_shipping/getall&token=<?php echo $token; ?>',
      beforeSend: function(){
  ...
  function getShopSection() {
    $.ajax({
      url: 'index.php?routes=extension/openbay/etsy_shop/getsections&token=<?php echo $token; ?>',
      beforeSend: function(){
