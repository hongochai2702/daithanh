...
$(document).delegate('#button-ip-add', 'click', function() {
	$.ajax({
		url: 'index.php?routes=user/api/addip&token=<?php echo $token; ?>&api_id=<?php echo $api_id; ?>',
		type: 'post',
...
// Login to the API
$.ajax({
	url: '<?php echo $catalog; ?>index.php?routes=api/login',
	type: 'post',
...
$('select[name=\'currency\']').on('change', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/currency&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/cart/products&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		dataType: 'json',
		crossDomain: true,
		success: function(json) {
...
$('input[name=\'customer\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?routes=customer/customer/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				json.unshift({
					customer_id: '0',
...
$('select[name=\'customer_group_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?routes=customer/customer/customfield&token=<?php echo $token; ?>&customer_group_id=' + this.value,
		dataType: 'json',
		success: function(json) {
			$('.custom-field').hide();
...
$('#button-customer').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/customer&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
                ...
                var request_1 = $.ajax({
                    url: '<?php echo $catalog; ?>index.php?routes=api/cart/add&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
                    type: 'post',
                ...
                var request_2 = request_1.then(function() {
                    $.ajax({
                        url: '<?php echo $catalog; ?>index.php?routes=api/voucher/add&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
                        type: 'post',
...
$('#cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/cart/remove&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
		url: 'index.php?routes=customer/customer/address&token=<?php echo $token; ?>&address_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#tab-payment select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?routes=localisation/country/country&token=<?php echo $token; ?>&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#button-payment-address').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/payment/address&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Payment Methods
				$.ajax({
					url: '<?php echo $catalog; ?>index.php?routes=api/payment/methods&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					crossDomain: true,
					beforeSend: function() {
						$('#button-payment-address').button('loading');
...
$('#button-shipping-address').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/shipping/address&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Shipping Methods
				var request = $.ajax({
					url: '<?php echo $catalog; ?>index.php?routes=api/shipping/methods&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					beforeSend: function() {
						$('#button-shipping-address').button('loading');
					},
...
$('#button-shipping-method').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/shipping/method&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-payment-method').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/payment/method&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-coupon').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/coupon&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-voucher').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/voucher&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-reward').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?routes=api/reward&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('input[name=\'affiliate\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?routes=marketing/affiliate/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				json.unshift({
					affiliate_id: 0,
...
$('#button-save').on('click', function() {
	if ($('input[name=\'order_id\']').val() == 0) {
		var url = '<?php echo $catalog; ?>index.php?routes=api/order/add&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = '<?php echo $catalog; ?>index.php?routes=api/order/edit&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + $('input[name=\'order_id\']').val();
	}
...
$('#content').delegate('button[id^=\'button-upload\'], button[id^=\'button-custom-field\'], button[id^=\'button-payment-custom-field\'], button[id^=\'button-shipping-custom-field\']', 'click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: 'index.php?routes=tool/upload/upload&token=<?php echo $token; ?>',
				type: 'post',
				dataType: 'json',
