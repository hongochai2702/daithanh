  ...
  <div class="page-header">
    ...
    <div class="container-fluid">
      ...
      <div class="pull-right">
        ...
        <button type="submit" form="form-reviewsev" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-reviewsev" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" name="service" value="<?php echo $service; ?>" placeholder="<?php echo $entry_service; ?>" id="input-service" class="form-control" />

              <input type="hidden" name="service_id" value="<?php echo $service_id; ?>" />

              <?php if ($error_service) { ?>

              <div class="text-danger"><?php echo $error_service; ?></div>
...
$('input[name=\'service\']').autocomplete({
	...
	'select': function(item) {
		...
		$('input[name=\'service\']').val(item['label']);

		$('input[name=\'service_id\']').val(item['value']);		
