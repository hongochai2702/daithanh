              ...
              <div class="panel-body">
                <form action="<?php echo $groupSingleAdd; ?>" method="post" enctype="multipart/form-data" id="form-link">
                  ...
                  <div class="form-group">
                    ...
                    <select name="module_type" id="input-module_type" class="form-control" onchange="$('#input-module_id').load('index.php?routes=design/menu/species&token=<?php echo $token; ?>&module_type=' + this.value + '&module_id=&menu_id=<?php echo $menu_info['menu_id']; ?>&menu_group_id=');">
                      ...
                      <option value="product" <?php if($module_type=='product'){ echo 'selected'; } ?>><?php echo $text_product; ?></option>
                       <option value="blog" <?php if($module_type=='blog'){ echo 'selected'; } ?>><?php echo $text_blog; ?></option>
                      <option value="category" <?php if($module_type=='category'){ echo 'selected'; } ?>><?php echo $text_category; ?></option>
                      <option value="categoryblog" <?php if($module_type=='categoryblog'){ echo 'selected'; } ?>><?php echo $text_categoryblog; ?></option>
                  ...
                  <div class="form-group">
                    ...
                    <select name="module_id" id="input-module_id" class="form-control" onclick="$.get('index.php?routes=design/menu/moduleurl&token=<?php echo $token; ?>&module_type=' + $('#input-module_type').val() + '&module_id=' + this.value + '&menu_id=<?php echo $menu_info['menu_id']; ?>', function(response_url){ $('#input-url').val(response_url); });"></select>
                  </div>
                  <div class="form-group required">
                  ...
                  <div class="form-group required">
                    ...
                    <input type="text" name="keyword" value="<?php echo $keyword; ?>" onfocus="$.get('index.php?routes=design/menu/moduleseo&token=<?php echo $token; ?>&module_url=' + $('#input-url').val() + '&menu_id=<?php echo $menu_info['menu_id']; ?>', function(response_keyword){ $('#input-keyword').val(response_keyword); });" placeholder="<?php echo $input_keyword; ?>" id="input-keyword" class="form-control" />
                  </div>
    		      <div class="form-group">
              ...
              <div class="panel-body">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                      ...
                      <input id="collective_type_blog" name="collective_type" value="blog" checked="checked" type="radio"><?php echo $text_blog; ?></label>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      <label for="collective_type_categoryblog" class="radio-inline">
                      <input id="collective_type_categoryblog" name="collective_type" value="categoryblog" type="radio"><?php echo $text_categoryblog; ?></label>
                    </div>
                    <div class="col-lg-6">
                ...
                <!--custom blog-->
                <div id="collective_type_contents_blog" class="col-lg-12">
                  <form action="<?php echo $groupMultipleAdd; ?>" method="post" enctype="multipart/form-data" id="form-blog">
                  <div class="form-group">
                     <div class="col-sm-12">
                       <input type="text" name="blog" value="" placeholder="<?php echo $text_blog; ?>" id="input-blog" class="form-control" />
                  ...
                  <div class="form-group">
                    <div class="col-sm-12"><button type="submit" id="form-blog" form="form-blog" class="btn btn-primary pull-right"><i class="fa fa-plus-circle"></i> <?php echo $button_menu_add; ?> <?php echo $text_blog; ?></button></div>
                  </div>
                </div>
                <!-- end custom blog-->
                ...
                <!--custom blog-->
                <div id="collective_type_contents_categoryblog" class="col-lg-12" style="display: none;">
                  <form action="<?php echo $groupMultipleAdd; ?>" method="post" enctype="multipart/form-data" id="form-categoryblog">
                  <div class="form-group">
                     <div class="col-sm-12">
                       <input type="text" name="categoryblog" value="" placeholder="<?php echo $text_categoryblog; ?>" id="input-categoryblog" class="form-control" />
                       <div id="menu-categoryblog" class="well well-sm" style="height: 150px; overflow: auto;"></div>
                     </div>
                  </div>
                  <input type="hidden" name="menu_id" value="<?php echo $menu_info['menu_id']; ?>">
                  <input type="hidden" name="module_type" value="categoryblog">
                  </form>
                  <div class="form-group">
                    <div class="col-sm-12"><button type="submit" id="form-categoryblog" form="form-categoryblog" class="btn btn-primary pull-right"><i class="fa fa-plus-circle"></i> <?php echo $button_menu_add; ?> <?php echo $text_categoryblog; ?></button></div>
                  </div>
                </div>
                <!--custom blog-->
...
$('#input-module_id').load('index.php?routes=design/menu/species&token=<?php echo $token; ?>&module_type=<?php echo $menu_group['module_type']; ?>&module_id=<?php echo $menu_group['module_id']; ?>&menu_id=<?php echo $menu_group['menu_id']; ?>&menu_group_id=<?php echo $menu_group['menu_group_id']; ?>');
</script>
<?php } ?>
...
$('input[name=\'collective_type\']').on('change', function() {
  ...
  if (this.value == 'product') {
    ...
    $('#collective_type_contents_categoryblog').hide();
  ...
  if (this.value == 'category') {
   ...
   if (this.value == 'categoryblog') {
    $('#collective_type_contents_blog').hide();
    $('#collective_type_contents_categoryblog').show();
    $('#collective_type_contents_information').hide();
    $('#collective_type_contents_manufacturer').hide();
  }
...
$('input[name=\'product\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?routes=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('input[name=\'category\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?routes=catalog/category/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'categoryblog\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?routes=catalog/categoryblog/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
      success: function(json) {
        response($.map(json, function(item) {
          return {
  ...
  'select': function(item) {
    ...
    $('#menu-categoryblog' + item['value']).remove();
    $('#menu-categoryblog').append('<div id="menu-categoryblog' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="menu_categoryblog[]" value="' + item['value'] + '" /></div>');  
  } 
});
$('#menu-categoryblog').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
...
$('input[name=\'information\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?routes=design/menu/autocompleteinformation&token=<?php echo $token; ?>&filter_title=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'manufacturer\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?routes=catalog/manufacturer/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
