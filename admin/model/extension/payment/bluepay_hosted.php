...
class ModelExtensionPaymentBluePayHosted extends Model {
	...
	public function void($order_id) {
		...
		if (!empty($bluepay_hosted_order) && $bluepay_hosted_order['release_status'] == 1) {
			...
			$void_data['APPROVED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
			$void_data['DECLINED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
			$void_data['MISSING_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
	...
	public function release($order_id, $amount) {
		...
		if (!empty($bluepay_hosted_order) && $bluepay_hosted_order['release_status'] == 0 && ($total_released + $amount <= $bluepay_hosted_order['total'])) {
			...
			$release_data['APPROVED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
			$release_data['DECLINED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
			$release_data['MISSING_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
	...
	public function rebate($order_id, $amount) {
		...
		if (!empty($bluepay_hosted_order) && $bluepay_hosted_order['rebate_status'] != 1) {
			...
			$rebate_data['APPROVED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
			$rebate_data['DECLINED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
			$rebate_data['MISSING_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_hosted/adminCallback';
