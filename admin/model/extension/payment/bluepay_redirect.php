...
class ModelExtensionPaymentBluepayredirect extends Model {
	...
	public function void($order_id) {
		...
		if (!empty($bluepay_redirect_order) && $bluepay_redirect_order['release_status'] == 1) {
			...
			$void_data['APPROVED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
			$void_data['DECLINED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
			$void_data['MISSING_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
	...
	public function release($order_id, $amount) {
		...
		if (!empty($bluepay_redirect_order) && $bluepay_redirect_order['release_status'] == 0 && ($total_released + $amount <= $bluepay_redirect_order['total'])) {
			...
			$release_data['APPROVED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
			$release_data['DECLINED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
			$release_data['MISSING_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
	...
	public function rebate($order_id, $amount) {
		...
		if (!empty($bluepay_redirect_order) && $bluepay_redirect_order['rebate_status'] != 1) {
			...
			$rebate_data['APPROVED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
			$rebate_data['DECLINED_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
			$rebate_data['MISSING_URL'] = HTTP_CATALOG . 'index.php?routes=extension/payment/bluepay_redirect/callback';
