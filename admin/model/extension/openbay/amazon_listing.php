...
class ModelExtensionOpenBayAmazonListing extends Model {
	...
	public function simpleListing($data) {
		$request = array(
			...
			'response_url' => HTTPS_CATALOG . 'index.php?routes=extension/openbay/amazon/listing',
	...
	public function doBulkSearch($search_data) {
		...
		$request_data = array(
			'search' => $search_data,
			'response_url' => HTTPS_CATALOG . 'index.php?routes=extension/openbay/amazon/search'
		);
