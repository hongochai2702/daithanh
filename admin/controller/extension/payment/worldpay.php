...
class ControllerExtensionPaymentWorldpay extends Controller {
	...
	public function index() {
		...
		$data['worldpay_webhook_url'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/worldpay/webhook&token=' . $data['worldpay_secret_token'];

		$data['worldpay_cron_job_url'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/worldpay/cron&token=' . $data['worldpay_secret_token'];
