...
class ControllerExtensionPaymentPPPayflowIframe extends Controller {
	...
	public function index() {
		...
		$data['post_url'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/pp_payflow_iframe/paymentipn';
		$data['cancel_url'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/pp_payflow_iframe/paymentcancel';
		$data['error_url'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/pp_payflow_iframe/paymenterror';
		$data['return_url'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/pp_payflow_iframe/paymentreturn';
