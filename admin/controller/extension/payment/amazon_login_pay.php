...
class ControllerExtensionPaymentAmazonLoginPay extends Controller {
	...
	public function index() {
		...
		$data['ipn_url'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/amazon_login_pay/ipn&token=' . $data['amazon_login_pay_ipn_token'];
		...
		$data['login_redirect_urls'][] = HTTPS_CATALOG . 'index.php?routes=payment/amazon_login/login';
		$data['login_redirect_urls'][] = HTTPS_CATALOG . 'index.php?routes=payment/amazon_pay/login';
