...
class ControllerExtensionPaymentLaybuy extends Controller {
	...
	public function index() {
		...
		$data['laybuy_cron_url'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/laybuy/cron&token=' . $data['laybuy_token'];
	...
	public function revise() {
		...
		if ($this->user->hasPermission('modify', 'extension/payment/laybuy')) {
			if ($this->request->server['REQUEST_METHOD'] == 'POST') {
				...
				$data['RETURNURL'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/laybuy/reviseCallback';
				$data['CANCELURL'] = HTTPS_CATALOG . 'index.php?routes=extension/payment/laybuy/reviseCancel';
