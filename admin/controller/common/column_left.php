		...
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($catalog) {
				...
				$data['menus'][] = array(
					...
					'name'	   => $this->language->get('text_post_type'),

					'href'     => $this->url->link('post_type/pages', 'token=' . $this->session->data['token'], true) ,
			...
			if ($this->user->hasPermission('access', 'testimonial/testimonial')) {		
				...
				$testimonial[] = array(
					...
					'name'	   => $this->language->get('text_testimonial_list'),
			...
			if ($this->user->hasPermission('access', 'testimonial/testimonial')) {		
				...
				$testimonial[] = array(
					...
					'name'	   => $this->language->get('text_testimonial_add'),

					'href'     => $this->url->link('testimonial/testimonial/add', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'testimonial/testimonial_category')) {		

				$testimonial[] = array(

					'name'	   => $this->language->get('text_testimonial_category'),

					'href'     => $this->url->link('testimonial/testimonial_category', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'blogs/blogs')) {		

				$blogs[] = array(

					'name'	   => $this->language->get('text_blogs_list'),

					'href'     => $this->url->link('blogs/blogs', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'blogs/blogs')) {		
				...
				$blogs[] = array(
					...
					'name'	   => $this->language->get('text_blogs_add'),

					'href'     => $this->url->link('blogs/blogs/add', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'blogs/blogs_category')) {		

				$blogs[] = array(

					'name'	   => $this->language->get('text_blogs_category'),

					'href'     => $this->url->link('blogs/blogs_category', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'portfolio/portfolio')) {		

				$portfolio[] = array(

					'name'	   => $this->language->get('text_portfolio_list'),

					'href'     => $this->url->link('portfolio/portfolio', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'portfolio/portfolio')) {		
				...
				$portfolio[] = array(
					...
					'name'	   => $this->language->get('text_portfolio_add'),

					'href'     => $this->url->link('portfolio/portfolio/add', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'portfolio/portfolio_category')) {		

				$portfolio[] = array(

					'name'	   => $this->language->get('text_portfolio_category'),

					'href'     => $this->url->link('portfolio/portfolio_category', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'catalog/service')) {		
				...
				$service[] = array(
					...
					'name'	   => $this->language->get('text_service_list'),
			...
			if ($this->user->hasPermission('access', 'catalog/service')) {		
				...
				$service[] = array(
					...
					'name'	   => $this->language->get('text_service_add'),

					'href'     => $this->url->link('catalog/service/add', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'catalog/categorysev')) {		

				$service[] = array(

					'name'	   => $this->language->get('text_categorysev'),

					'href'     => $this->url->link('catalog/categorysev', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'catalog/attributesev')) {

				$attributesev[] = array(

					'name'     => $this->language->get('text_attributesev'),

					'href'     => $this->url->link('catalog/attributesev', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'catalog/attributesev_group')) {

				$attributesev[] = array(

					'name'	   => $this->language->get('text_attributesev_group'),

					'href'     => $this->url->link('catalog/attributesev_group', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'catalog/optionsev')) {

				$service[] = array(

					'name'	   => $this->language->get('text_optionsev'),

					'href'     => $this->url->link('catalog/optionsev', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'catalog/manufacturersev')) {

				$service[] = array(

					'name'	   => $this->language->get('text_manufacturersev'),

					'href'     => $this->url->link('catalog/manufacturersev', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'catalog/downloadsev')) {

				$service[] = array(

					'name'	   => $this->language->get('text_downloadsev'),

					'href'     => $this->url->link('catalog/downloadsev', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'catalog/reviewsev')) {		

				$service[] = array(

					'name'	   => $this->language->get('text_reviewsev'),

					'href'     => $this->url->link('catalog/reviewsev', 'token=' . $this->session->data['token'], true),
			...
			if ($this->user->hasPermission('access', 'extension/module/visualbuilder')) {
				...
				$design[] = array(
					...
					'name'	   => $this->language->get('text_visualbuilder'),
